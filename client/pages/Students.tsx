    ...
    <main className="container py-12">
      <section className="rounded-2xl border border-border bg-white p-8 shadow-sm">
        ...
        <div className="mt-6 flex flex-wrap items-center gap-3">
          ...
          <a href="https://wa.me/" className="text-primary underline">Chat on WhatsApp</a>
        </div>
      </section>

      <section className="mt-10 grid gap-6 md:grid-cols-2">
        <div className="rounded-xl border border-border bg-muted/40 p-6">
          <ScrollFloat containerClassName="text-accent" textClassName="font-semibold">Student testimonials</ScrollFloat>
          <div className="overflow-hidden">
            <motion.div className="flex gap-4" animate={{ x: ["0%", "-50%"] }} transition={{ duration: 24, repeat: Infinity, ease: "linear" }}>
              {[
                { name: "Aoife, UCD", img: "https://images.unsplash.com/photo-1527980965255-d3b416303d12?w=200&h=200&fit=crop&auto=format", text: "Saved €210/yr. eSIM took 2 mins." },
                { name: "Ravi, TCD", img: "https://images.unsplash.com/photo-1529665253569-6d01c0eaf7b6?w=200&h=200&fit=crop&auto=format", text: "Great for shared housing bills." },
                { name: "Maya, NUIG", img: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=200&h=200&fit=crop&auto=format", text: "Love the green tariff." },
                { name: "Liam, DCU", img: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=200&h=200&fit=crop&auto=format", text: "Zero deposit was a lifesaver." },
              ].concat([
                { name: "Aoife, UCD", img: "https://images.unsplash.com/photo-1527980965255-d3b416303d12?w=200&h=200&fit=crop&auto=format", text: "Saved €210/yr. eSIM took 2 mins." },
                { name: "Ravi, TCD", img: "https://images.unsplash.com/photo-1529665253569-6d01c0eaf7b6?w=200&h=200&fit=crop&auto=format", text: "Great for shared housing bills." },
                { name: "Maya, NUIG", img: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=200&h=200&fit=crop&auto=format", text: "Love the green tariff." },
                ...
                <div key={i} className="min-w-[220px] flex items-center gap-3 rounded-xl border border-border bg-white p-3 shadow-sm">
        ...
        <div className="rounded-xl border border-border bg-muted/40 p-6">
          <ScrollFloat containerClassName="text-accent" textClassName="font-semibold">Add‑ons for students</ScrollFloat>
