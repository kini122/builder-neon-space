    ...
    <main className="container py-12">
      ...
      <div className="mt-4 space-y-4 text-foreground/80">
        <div>
          ...
          <p>By joining a community group we negotiate better bundle rates. Use the calculator to estimate your saving.</p>
        </div>
        <div>
        ...
        <div>
          <h2 className="font-semibold text-accent">Is the energy really green?</h2>
          <p>Yes. We use 100% renewable energy certificates under our Community Green Tariff.</p>
        </div>
      </div>
    </main>
  );
