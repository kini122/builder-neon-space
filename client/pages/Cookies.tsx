  ...
  return (
    <main className="container py-12">
      ...
      <div className="mt-4 prose max-w-none">
        <p>We use cookies to keep you logged in, remember preferences and measure site performance. You can opt out of non‑essential cookies in your browser settings.</p>
        <ul>
